...
from spritoglobin.classes import ObjFile, InvalidObjectFileError, GAME_IDS_THAT_USE_BOUNDING_BOXES
from spritoglobin.constants import *
from spritoglobin.scripts import create_transform_demo
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def change_lang(self, lang_key, reset_ui = True):
        ...
        self.strings = {
            ...
            "AnimationTabsSpriteColorAnimTitle":  self.tr("MainWindow.AnimationTabsSpriteColorAnimTitle"),
            "AnimationTabsSpriteGlobalAnimTitle": self.tr("MainWindow.AnimationTabsSpriteGlobalAnimTitle"),
            "ObjectSelectorTitle":                self.tr("MainWindow.ObjectSelectorTitle"),
            "AnimationSelectorTitle":             self.tr("MainWindow.AnimationSelectorTitle"),
            "ShowBoundingBoxToggle":              self.tr("MainWindow.ShowBoundingBoxToggle"),
            "ColorModeInfo":                      self.tr("MainWindow.ColorModeInfo"),
            "ColorAnimSelectorTitle":             self.tr("MainWindow.ColorAnimSelectorTitle"),
            "ColorAnimSelectorNone":              self.tr("MainWindow.ColorAnimSelectorNone"),
            ...
            "MenuBarFileQuickExportOption":       self.tr("MainWindow.MenuBarQuickExportOption"),
            "MenuBarFileExportOption":            self.tr("MainWindow.MenuBarExportOption"),
            ...
            "SpritePartSelectorNone":             self.tr("MainWindow.SpritePartSelectorNone"),
            "SpritePartSizeTitle":                self.tr("MainWindow.SpritePartSizeTitle"),
            "SpritePartBufferOffset":             self.tr("MainWindow.SpritePartBufferOffset"),
            "SpritePartSize0":                    self.tr("MainWindow.SpritePartSize0"),
            "SpritePartSize1":                    self.tr("MainWindow.SpritePartSize1"),
            "SpritePartSize2":                    self.tr("MainWindow.SpritePartSize2"),
            "SpritePartSize3":                    self.tr("MainWindow.SpritePartSize3"),
            "SpritePartShapeTitle":               self.tr("MainWindow.SpritePartShapeTitle"),
            "SpritePartShape0":                   self.tr("MainWindow.SpritePartShape0"),
            "SpritePartShape1":                   self.tr("MainWindow.SpritePartShape1"),
            "SpritePartShape2":                   self.tr("MainWindow.SpritePartShape2"),
            "SpritePartSizePixels":               self.tr("MainWindow.SpritePartSizePixels"),
            "SpritePartFlipHorizontal":           self.tr("MainWindow.SpritePartFlipHorizontal"),
            "SpritePartFlipVertical":             self.tr("MainWindow.SpritePartFlipVertical"),
            "SpritePartOffset":                   self.tr("MainWindow.SpritePartOffset"),
            "SpritePartRendererTitle":            self.tr("MainWindow.SpritePartRendererTitle"),
        }

        self.game_title_strings = {
            "GameTitleML1":  self.tr("MainWindow.GameTitleML1"),
            "GameTitleML2":  self.tr("MainWindow.GameTitleML2"),
            "GameTitleML3":  self.tr("MainWindow.GameTitleML3"),
            "GameTitleML4":  self.tr("MainWindow.GameTitleML4"),
            "GameTitleML5":  self.tr("MainWindow.GameTitleML5"),
            "GameTitleML1R": self.tr("MainWindow.GameTitleML1R"),
            "GameTitleML3R": self.tr("MainWindow.GameTitleML3R"),
        }
    ...
    class GraphicsAnimationTimeline(AnimationTimeline):
        ...
        def __init__(self, font, padding_amount, timeline_height, keyframe_padding, playhead_height):
            self.strings = {
                "ShowBoundingBoxToggle":            self.tr("MainWindow.GraphicsAnimationTimeline.ShowBoundingBoxToggle"),
                "FrameDataSpritePartsUsed":         self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataSpritePartsUsed"),
                "FrameDataSpritePartsUsedNone":     self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataSpritePartsUsedNone"),
                "FrameDataTransformMatrixUsed":     self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixUsed"),
                "FrameDataTransformMatrixUsedNone": self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixUsedNone"),
                "FrameDataTransformMatrixInverted": self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixInverted"),
                "FrameDataTransformMatrixXShear":   self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixXShear"),
                "FrameDataTransformMatrixYShear":   self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixYShear"),
                "FrameDataTransformMatrixXScale":   self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixXScale"),
                "FrameDataTransformMatrixYScale":   self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixYScale"),
                "FrameDataTransformMatrixXPos":     self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixXPos"),
                "FrameDataTransformMatrixYPos":     self.tr("MainWindow.GraphicsAnimationTimeline.FrameDataTransformMatrixYPos"),
            }
    ...
    class ColorAnimationTimeline(AnimationTimeline):
        ...
        def __init__(self, font, padding_amount, timeline_height, keyframe_padding, playhead_height):
            self.strings = {
                "LayerToggleTitle":       self.tr("MainWindow.ColorAnimationTimeline.LayerToggleTitle"),
                "LayerInfoRenderChannel": self.tr("MainWindow.ColorAnimationTimeline.LayerInfoRenderChannel"),
                "LayerInfoPersistant":    self.tr("MainWindow.ColorAnimationTimeline.LayerInfoPersistant"),
                "LayerInfoStartEndColor": self.tr("MainWindow.ColorAnimationTimeline.LayerInfoStartEndColor"),
                "LayerInfoColorRGB":      self.tr("MainWindow.ColorAnimationTimeline.LayerInfoColorRGB"),
                "LayerInfoColorA":        self.tr("MainWindow.ColorAnimationTimeline.LayerInfoColorA"),
            }
    ...
    class FileImportWindow(QtWidgets.QDialog):
        def __init__(self, parent, game_title_strings, current_window_icon):
            ...
            self.strings = {
                "ImportWindowTitle":          self.tr("MainWindow.FileImportWindow.ImportWindowTitle"),
                "ImportChooseFileButton":     self.tr("MainWindow.FileImportWindow.ImportChooseFileButton"),
                "ImportChooseFileTitle":      self.tr("MainWindow.FileImportWindow.ImportChooseFileTitle"),
                "ImportChooseFileBlurb":      self.tr("MainWindow.FileImportWindow.ImportChooseFileBlurb"),
                "ImportFileFailureTitle":     self.tr("MainWindow.FileImportWindow.ImportFileFailureTitle"),
                "ImportFileFailureBlurb":     self.tr("MainWindow.FileImportWindow.ImportFileFailureBlurb"),
                "ImportFileError100":         self.tr("MainWindow.FileImportWindow.ImportFileError100"),
                "ImportFileError101":         self.tr("MainWindow.FileImportWindow.ImportFileError101"),
                "ImportFileError102":         self.tr("MainWindow.FileImportWindow.ImportFileError102"),
                "FileInfoNone":               self.tr("MainWindow.FileImportWindow.FileInfoNone"),
                "FileInfoBG4TitleAndVersion": self.tr("MainWindow.FileImportWindow.FileInfoBG4TitleAndVersion"),
                "FileInfoValidEntryCount":    self.tr("MainWindow.FileImportWindow.FileInfoValidEntryCount"),
                "FileInfoCellAnimeTitle":     self.tr("MainWindow.FileImportWindow.FileInfoCellAnimeTitle"),
                "ImportAlphabetizeToggle":    self.tr("MainWindow.FileImportWindow.ImportAlphabetizeToggle"),
                "ImportAcceptButton":         self.tr("MainWindow.FileImportWindow.ImportAcceptButton"),
            }
    ...
    class GifExportWindow(QtWidgets.QDialog):
        def __init__(self, parent, current_window_icon, success_jingle, obj_data, use_low_framerate, initial_object, initial_animation, initial_color_anim):
            ...
            self.strings = {
                ...
                "AnimationOptionFramerate":        self.tr("MainWindow.GifExportWindow.AnimationOptionFramerate"),
                "AnimationOptionColorAnimTitle":   self.tr("MainWindow.GifExportWindow.AnimationOptionColorAnimTitle"),
                "AnimationOptionColorAnimNone":    self.tr("MainWindow.GifExportWindow.AnimationOptionColorAnimNone"),
                "AnimationListDataCurrentAnim":    self.tr("MainWindow.GifExportWindow.AnimationListDataCurrentAnim"),
                "AnimationListDataCurrentLoops":   self.tr("MainWindow.GifExportWindow.AnimationListDataCurrentLoops"),
                "ExportAcceptButton":              self.tr("MainWindow.GifExportWindow.ExportAcceptButton"),
                "ExportChooseFileTitle":           self.tr("MainWindow.GifExportWindow.ExportChooseFileTitle"),
                "ExportFileSuccessTitle":          self.tr("MainWindow.GifExportWindow.ExportFileSuccessTitle"),
                "ExportFileSuccessBlurb":          self.tr("MainWindow.GifExportWindow.ExportFileSuccessBlurb"),
            }
